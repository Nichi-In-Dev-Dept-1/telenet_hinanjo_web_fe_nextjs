...
const Layout = (props) => {
    ...
    const pageTitles_en = {
        ...
        "/user/register/member": "User - Register Member",
        "/user/register/member/details": "User - Register Member Details",
        "/user/checkout": "User - Checkout",
        "/user/checkout/details": "User - Checkout Details",
        "/user/external": "User - External",
        "/user/public-evacuees/": "User - Public Evacuees",
        "/user/temp-register": "User - Temporary Registration",
        "//user/temp-edit/confirm": "User - Temporary Details Confirmation",
        "/user/temp-register/success": "User - Temporary Registration Success",
        "/user/temp-edit": "User - Temporary Edit",
        "/user/person-count": "User - Person Count",
        "/user/event-list": "User - Event List",
        "/user/event-list/": "User - Event List",
        "/user/event/dashboard": "User - Event Dashboard",
        "/user/event/register": "User - Event Register",
        "/user/event/register/member": "User - Event Register Member",
        "/user/event/register/member/details": "User - Event Register Member Details",
        "/user/event/checkout": "User - Event Checkout",
        "/user/event-checkout/details": "User - Event Checkout Details",
        "/user/qr/app": "User - QR App",
        "/event/register/member/success": "User - Event Register Member Success",
    ...
    // User URLs  
    "/user/list": "ユーザー｜避難所管理システム一覧",
    "/user/dashboard": "ユーザー｜ダッシュボード",
    "/user/register/member": "ユーザー｜入所手続き",
    "/user/register/member/details": "ユーザー｜入所世帯情報",
    "/user/register": "ユーザー｜入所手続き",
    "/user/register/confirm": "ユーザー｜入所手続き確認",
    "/user/register/success": "ユーザー｜入所手続き成功",
    "/user/checkout": "ユーザー｜退所手続き",
    "/user/checkout/details": "ユーザー｜退所世帯情報",
    "/user/external": "ユーザー｜外部避難者登録",
    "/user/public-evacuees/": "ユーザー｜公共避難者登録",
    "/user/person-count": "ユーザー｜家族(数)",
    "/user/temp-register": "ユーザー｜避難前登録",
    "/user/temp-register/confirm": "ユーザー｜避難前登録確認",
    "/user/temp-person-count": "ユーザー｜家族(数)",
    "/user/temp-register/success": "ユーザー｜避難前登録手続き",
    "/user/temp-edit": "ユーザー｜避難前登録編集",
    "/user/event-list": "ユーザー｜イベント一覧",
    "/user/event-list/": "ユーザー｜イベント一覧",
    "/user/event/dashboard": "ユーザー｜イベントダッシュボード",
    "/user/event/register": "ユーザー｜イベント登録",
    "/user/event/register/member": "ユーザー｜入場手続き",
    "/user/event/checkout": "ユーザー｜退場手続き",
    "user/qr/app": "ユーザー｜QRコード登録",
    "/event/register/member/success": "ユーザー｜登録完了",
